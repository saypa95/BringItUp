...
window.addEventListener("DOMContentLoaded", function () {
  ...
  try {
    var bigMainSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_1__["default"]({
      sliderSelector: ".page",
      nextSelcetor: ".next"
    });
    bigMainSlider.render();
  } catch (e) {
    var bigModulesSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  feedSlider.init();
  var player = new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_3__["default"](".overlay", ".showup .play");
  player.init();
});
