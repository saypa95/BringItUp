...
window.addEventListener("DOMContentLoaded", function () {
  ...
  try {
    var bigMainSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_4__["default"]({
      sliderSelector: ".page",
      nextSelcetor: ".next"
    });
    bigMainSlider.render();
    var showUpSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    showUpSlider.init();
    var modulesSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    modulesSlider.init();
    var feedSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    feedSlider.init();
    var officerOld = new _modules_officer__WEBPACK_IMPORTED_MODULE_3__["default"](".officerold", ".officer__card-item", ".plus");
    officerOld.init();
    var officerNew = new _modules_officer__WEBPACK_IMPORTED_MODULE_3__["default"](".officernew", ".officer__card-item", ".plus");
    officerNew.init();
    var mainForm = new _modules_form__WEBPACK_IMPORTED_MODULE_2__["default"](".form");
    mainForm.init();
    var scheldueForm = new _modules_form__WEBPACK_IMPORTED_MODULE_2__["default"](".schedule__form .form");
    scheldueForm.init();
    var player = new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_6__["default"](".overlay", "[data-url]");
    player.init();
  } catch (e) {
    var bigModulesSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_4__["default"]({
    ...
    var _player = new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_6__["default"](".overlay", "[data-url]");

    _player.init();

    new _modules_accordion__WEBPACK_IMPORTED_MODULE_0__["default"](".plus").init();
    ...
    value: function bindTriggers() {
      this.triggers.forEach(function (item) {
        item.addEventListener("click", function () {
          var blockToShow = item.parentNode.nextElementSibling;
  ...
  _createClass(Form, [{
    ...
    value: function init() {
      ...
      this.form.addEventListener("submit", function (e) {
        e.preventDefault();
        _this.statusMessage.style.cssText = "\n                    margin-top: 15px;\n                    margin-left: 5px;\n                    font-weight: 400;\n                    line-height: 18px;\n                    font-size: 18px;\n                    color: #000;\n                    mix-blend-mode: normal;\n                    opacity: .89;\n                ";

        _this.form.parentNode.append(_this.statusMessage);

        _this.statusMessage.textContent = _this.message.loading;
...
/*#__PURE__*/
function () {
  function Officer(officerSelector, itemSelector, triggerSelector) {
...
function (_Slider) {
  ...
  function MainSlider(_ref) {
    ...
    var sliderSelector = _ref.sliderSelector,
        nextSelcetor = _ref.nextSelcetor,
        prevSelector = _ref.prevSelector;

    _classCallCheck(this, MainSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, sliderSelector));
    _this.nextBtns = document.querySelectorAll(nextSelcetor);
    _this.prevBtn = document.querySelectorAll(prevSelector);
    _this.scheduleBtn = document.querySelectorAll(".menu__block-schedule");
    return _this;
  }
...
function (_Slider) {
  ...
  function MiniSlider(_ref) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, sliderSelector));
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener("click", function () {
        if (_this3.slides[_this3.slides.length - 1].tagName == "BUTTON") {
          do {
            _this3.slider.prepend(_this3.slides[_this3.slides.length - 1]);
          } while (_this3.slides[_this3.slides.length - 1].tagName == "BUTTON");
        }
...
/*#__PURE__*/
function () {
  function VideoPlayer(overlaySelector, triggersSelector) {
